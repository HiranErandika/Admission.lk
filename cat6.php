...
<div class="container">
  ...
  <h4> 11.0 Children of persons arriving after living abroad with the child </h4>
    <div class="form-group">
      <label>11.1 Date returned to the country</label>
     </div>
     <div class="col-sm-4"> 
       
      <select name="dob" class="form-control input-sm">
    ...
    <div class="form-group col-sm-4">
      ...
      <select name="mob" class="form-control input-sm">
    ...
    <div class="form-group">
      <label>11.3  Period of continuously staid abroad with the child</label>
     </div>

    <div class="form-group col-sm-4">
  
      <select name="yob" class="form-control input-sm"><option value="0">Years</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option></select>
    </div>
    <br>
